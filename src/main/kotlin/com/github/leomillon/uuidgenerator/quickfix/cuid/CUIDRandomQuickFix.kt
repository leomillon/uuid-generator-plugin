...
class CUIDRandomQuickFix(
    private val textRange: TextRange
) : BaseIntentionAction(), HighPriorityAction {

    override fun getFamilyName(): String = "Random"

    override fun getText(): String = "Replace with new random CUID"

    override fun isAvailable(project: Project, editor: Editor, file: PsiFile?): Boolean = true

    override fun invoke(project: Project, editor: Editor, file: PsiFile?) {
        WriteCommandAction.runWriteCommandAction(project) {
            EditorDocumentUtils.replaceTextAtRange(editor, textRange, CUIDGenerator.generateCUID())
        }
    }
}
